...
| 2026-08-10 | Community Web power controls: roving keyboard message navigation plus one safe local action registry for prompt macros, exact voice phrases, and WebMCP tools; `agents_member`, `craft`, and `moderation-notifications` remain honestly **partial**. |
