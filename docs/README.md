...
| [ADR-0042: Spaces — Shared, Signed, Joinable Workspaces](design-decisions/0042-spaces-shared-signed-workspaces.md) | `epoch.space/v1`: a joinable object composing View, Workspaces, conversation, authority, and per-turn Sandbox bindings; what a Space is not; and which phases shipped. |
