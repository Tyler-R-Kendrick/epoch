...
| [Community Web Feed/Thread + Receipt Chrome](evidence/community-web-feed-thread-receipt/README.md) | Session evidence for single-column threads and Bracket Rule receipt locator gating. |
...
| [Community Web Feed/Thread Nav State](plans/community-web-feed-thread-nav/sdlc-state.md) | Session record for single-column threads and receipt chrome lint. |
