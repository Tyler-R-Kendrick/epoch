...
| [Community Web Feed/Thread + Receipt Chrome](evidence/community-web-feed-thread-receipt/README.md) | Session evidence for roots-only channel feeds, single-column threads, and Bracket Rule receipt locator gating. |
