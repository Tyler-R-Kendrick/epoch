...
| [ADR-0028: Recoverable Community Web Startup, Sticky Routing, And Deterministic HoBo Authoring](design-decisions/0028-community-web-startup-routing-and-hobo-authoring.md) | Defines the Ctrl+U restart inbox, workspace route affinity, and Bo's checked HoBo app loop. |
...
| [ADR-0042: One Community Command Layer](design-decisions/0042-community-runtime-command-layer.md) | Makes one command bus, receipt schema, browser UI workspace, and static harness ABI serve web, WebMCP, CLI, and SDK. |
