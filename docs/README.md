...
| [Nightboard](design-explorations/nightboard/README.md) | The chosen direction built for real: a live keyboard-operated board, ten themes, and a zen-garden theming contract with on-device theme generation. |
