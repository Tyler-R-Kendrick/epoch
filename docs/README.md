...
| [Nightboard](design-explorations/nightboard/README.md) | **Committed Community visual world** ([ADR-0027](design-decisions/0027-community-visual-world-nightboard.md)): Tron TUI / Grid theme, keyboard-first board. Default `/` is the Persuade marketing landing; Operate board is `board.html`. Impeccable iterates here until Community Web parity. Evidence under [`evidence/nightboard/`](evidence/nightboard/README.md). |
...
| [ADR-0027: Community Visual World Nightboard](design-decisions/0027-community-visual-world-nightboard.md) | Commits Nightboard (Grid) as the Community visual world; Impeccable iterates on the Nightboard exploration until Community Web parity. |
