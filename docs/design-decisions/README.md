...
| [ADR-0030](0030-stable-changes-revisions-stacks-reviews-merges.md) | Accepted | Separate stable changes from immutable revisions and bind stacks, review bundles, and merge plans to exact graph state. |
...
| [ADR-0030](0030-stable-changes-revisions-stacks-reviews-merges.md) | Accepted and implemented | Model stable change lineages, immutable revisions, dependency stacks, exact review evidence, and stale-safe merge plans without rewriting legacy events. |
