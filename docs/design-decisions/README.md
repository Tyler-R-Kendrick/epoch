...
| [ADR-0061](0061-crt-tube-pass.md) | Accepted | Landing CRT becomes a full tube pass in `crt.js` (aperture grille, halation, screen-derived raster, lit room, `uMotion`-gated animation) with a static face layer so DOM copy wears the raster; measured contrast cost 11.5:1 → 8.95:1 against a 7:1 floor, pinned by assertion. |
