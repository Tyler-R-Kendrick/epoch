...
| [ADR-0059](0059-social-catalog-bundles-feed-scripts-and-app-tier.md) | Proposed | Additive over ADR-0058: named social-primitive catalog with gesture-only consequential actions, hash-pinned community bundles with member-granular killbit, identifier-only feed-skeleton scripts hydrated host-side, and a reserved sandboxed-iframe app tier. |
