...
| [ADR-0054](0054-nats-realtime-fabric.md) | Accepted | Host nats-server (JetStream + WebSocket) with complementary Epoch auth callout (opaque fabric credentials + scoped ACLs); nats.ws clients; dumb Live fan-out. |
