# ADR-0038: Workspace Selection, Materialization Modes, And The Namespace Manifest
...
- [ADR-0037: Repository Composition And Repository Links](0037-repository-composition-and-links.md)
