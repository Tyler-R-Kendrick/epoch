...
| [`features/community_web_experience.feature`](../features/community_web_experience.feature) | Community Web responsive and 200%-zoom channel navigation, message feed, snapshot action recovery, selected-message signed actions, live intent promotion, agent requests, unified comments, and moderation/legal-hold evidence. |
