...
| `@epoch/protocol` + convergence Core | Browser-safe schemas/revsets/inspection, change-stack-merge graphs, durable conflicts, explicit-parent transactions, object/chunk/promise verification, native sync, and workspaces in the frontier-focused unit suites. |
