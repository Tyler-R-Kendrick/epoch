/**
 * Optimized clipboard formats for Nightboard content.
 *
...
(function () {
  ...
  function memberRole(who) {
    try {
      var m = window.NB_MAP && window.NB_MAP.findMember && window.NB_MAP.findMember(who);
  ...
  function formatForTarget(target, state) {
    ...
    if (target.kind === "activity") {
      ...
      if (!n && (D = window.NB_DATA) && D.notifications) {
