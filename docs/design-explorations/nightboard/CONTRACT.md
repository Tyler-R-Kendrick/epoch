...
Persisted schema migration may resolve pre-release `nightboard:` locators and
slug paths once into canonical links; they are not product APIs. URLs, history,
notification targets, share locators, and action events
