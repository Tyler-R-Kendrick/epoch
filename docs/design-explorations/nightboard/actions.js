...
(function () {
  ...
  [
    ...
    { actionId: "view.sort", label: "Sort view", description: "Set hot, new, top, or best order", commandAliases: ["sort", "view"], commandArg: "sort", slashAliases: ["/sort"], slashArg: "sort", run: "sort" },
    { actionId: "view.filter", label: "Query view", description: "Apply the normalized Community query projection", commandAliases: ["search"], commandArg: "query", slashAliases: ["/view", "/q", "/query", "/search"], slashArg: "query", run: "view" },
    ...
    { actionId: "compose.reply", label: "Reply", description: "Arm a reply to the selected object", slashAliases: ["/reply"], slashArg: "text", run: "reply", hidden: true },
    { actionId: "channel.create", label: "Create channel", description: "Create a channel in the current project", slashAliases: ["/channel"], slashArg: "new name", run: "channel", hidden: true },
    { actionId: "project.create", label: "Create project", description: "Create a project", slashAliases: ["/project"], slashArg: "new name", run: "project", hidden: true },
