...
[ADR-0044](design-decisions/0044-sandboxed-capability-providers.md): providers
...
([ADR-0045](design-decisions/0045-publisher-key-lifecycle.md)):
...
rather than becoming the parse error that disarms the policy (ADR-0047). Keys
...
refused by name rather than quoted and hoped for (ADR-0043).
