...
| Fuzz lanes, corpora, regression promotion, scheduled fuzz CI, or coverage floors that exist so fuzz/history work cannot silently drop measured Node coverage | `docs/design-decisions/0052-model-based-and-coverage-guided-fuzzing.md`, `test/fuzz/README.md`, `.c8rc.json`, and `docs/change-graph.md` when Change Graph surfaces change |
