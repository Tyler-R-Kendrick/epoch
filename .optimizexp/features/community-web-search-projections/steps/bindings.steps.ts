/**
 * Cucumber step bindings for OptimizeXP feature `community-web-search-projections`.
...
function getSingleton(): OptimizexpWorld {
  singleton ??= createWorld("community-web-search-projections");
  return singleton;
}
...
Given("persona {string} is active", function (this: OptimizexpWorld, personaId: string) {
  ...
  if (!world.featureId) Object.assign(world, createWorld("community-web-search-projections"));
