/**
 * Cucumber step bindings for OptimizeXP feature `community-web-daily-navigation`.
...
function getSingleton(): OptimizexpWorld {
  singleton ??= createWorld("community-web-daily-navigation");
  return singleton;
}
...
Given("persona {string} is active", function (this: OptimizexpWorld, personaId: string) {
  ...
  if (!world.featureId) Object.assign(world, createWorld("community-web-daily-navigation"));
