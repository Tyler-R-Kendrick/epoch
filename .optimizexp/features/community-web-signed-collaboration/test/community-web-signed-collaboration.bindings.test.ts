/**
 * Vitest binding/smoke tests for OptimizeXP feature `community-web-signed-collaboration`.
...
describe("optimizexp feature community-web-signed-collaboration bindings", () => {
  ...
  it("sets persona and feature context", () => {
    const world = createWorld("community-web-signed-collaboration");
    setPersona(world, "developer");
    setFeatureContext(world, "community-web-signed-collaboration");
    expect(world.personaId).toBe("developer");
    expect(world.featureId).toBe("community-web-signed-collaboration");
  });
