/**
 * Cucumber step bindings for OptimizeXP feature `community-web-signed-collaboration`.
...
function getSingleton(): OptimizexpWorld {
  singleton ??= createWorld("community-web-signed-collaboration");
  return singleton;
}
...
Given("persona {string} is active", function (this: OptimizexpWorld, personaId: string) {
  ...
  if (!world.featureId) Object.assign(world, createWorld("community-web-signed-collaboration"));
