/**
 * Vitest binding/smoke tests for OptimizeXP feature `community-web-responsive-craft`.
...
describe("optimizexp feature community-web-responsive-craft bindings", () => {
  ...
  it("sets persona and feature context", () => {
    const world = createWorld("community-web-responsive-craft");
    setPersona(world, "developer");
    setFeatureContext(world, "community-web-responsive-craft");
    expect(world.personaId).toBe("developer");
    expect(world.featureId).toBe("community-web-responsive-craft");
  });
