 ...
 * both, so signing the manifest transitively binds every module (ADR-0044).
 */
...
export interface ExtensionManifest {
   ...
   * before, which is why adding this breaks no existing signature (ADR-0045).
   */
...
/**
 * Read a manifest with the complete TOML reader (ADR-0047).
 *
