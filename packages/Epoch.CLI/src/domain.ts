...
export const CliText = {
  ...
  usage: "usage: epoch [--repo PATH] <init|record|intent|events|verify|merge|reject|comment|status|main|resolve|sync|rollback|view-create|views|checkout|view-delete|view-diff|view-promote|import|export|dr-plan>",
