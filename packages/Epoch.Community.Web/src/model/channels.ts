...
export const defaultWorkChannels: readonly CommunityChannel[] = [
  {
    ...
    label: "support",
    kind: "work",
    topic: "Get unstuck, accept answers, and turn repeated help into docs patches.",
  ...
  },
  {
    ...
    label: "ideas",
    kind: "work",
    topic: "Shape product ideas into signed intents, previews, and reviewable patches.",
  ...
  },
  {
    ...
    label: "bugs",
    kind: "work",
    topic: "Reproduce defects and connect reports to patches without losing context.",
  ...
  },
  {
    ...
    label: "agent-runs",
    kind: "work",
    topic: "Watch policy-bound agents propose work while humans keep merge authority.",
  ...
  },
  {
    ...
    label: "previews",
    kind: "work",
    topic: "Review deploy previews, visual results, and release readiness in one thread.",
  ...
  },
  {
    ...
    label: "governance",
    kind: "work",
    topic: "Handle moderation, legal hold, witnesses, and signed release trust.",
...
export const defaultSocialChannels: readonly CommunityChannel[] = [
  {
    ...
    label: "general",
    kind: "social",
    topic: "Day-to-day community hangout — independent of any single repository.",
  ...
  },
  {
    ...
    label: "showcase",
    kind: "social",
    topic: "Share demos, screenshots, and wins with the community.",
