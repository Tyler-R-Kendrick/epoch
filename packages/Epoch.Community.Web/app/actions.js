...
(function () {
  ...
  [
    ...
    { actionId: "workspace.new", label: "New workspace", description: "Open an isolated Community Web workspace", slashAliases: ["/tab", "/workspace"], run: "tab" },
    ...
    { actionId: "hooks.test", label: "Test hook", description: "Fire a hook for the selected object only" },
    { actionId: "post.mute", label: "Mute object", description: "Mute the selected post or member", sideEffect: "local" },
    { actionId: "post.report", label: "Report object", description: "Report the selected object for legal hold", sideEffect: "local" },
    ...
    { actionId: "keymap.use", label: "Keymap", description: "List or activate a keymap.toml loadout (epoch, vim, yazi, emacs, lazygit, …)", commandAliases: ["keymap"], commandArg: "loadout", slashAliases: ["/keymap"], slashArg: "loadout", run: "keymap", hidden: true },
