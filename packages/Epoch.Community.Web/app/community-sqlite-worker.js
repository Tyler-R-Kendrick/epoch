...
var require_errors = __commonJS({
  "packages/Epoch.Community.Core/dist/errors.js"(exports) {
    ...
    function isCommunityError(error) {
      if (error instanceof CommunityError4)
        return true;
      if (!isErrorDetails(error))
        return false;
      const details = error;
      const code = details.code;
      return details.name === "CommunityError" && isString2(details.message) && isCommunityErrorCode(code) && details.httpStatus === communityErrorHttpStatus(code);
    }
...
var require_entity = __commonJS({
  "packages/Epoch.Community.Core/dist/entity.js"(exports) {
    ...
    function validateIsoDateTime(value, label = "datetime") {
      if (!isString2(value) || value.length > 128 || !/(?:Z|[+-]\d{2}:\d{2})$/u.test(value)) {
    ...
    function validateSearchableText(value) {
      ...
      for (const [name, text] of Object.entries(value)) {
        if (!FIELD_NAME.test(name) || !isString2(text) || text.length > 1e7)
    ...
    function validateProvenanceUri(value) {
      if (!isString2(value) || value.length === 0 || value.length > 4096 || [...value].some((character) => {
    ...
    function canonicalStrings(value, label = "values", sort = true) {
      if (!Array.isArray(value) || value.length > 4096 || value.some((item) => !isString2(item) || item.length > 4096)) {
    ...
    function boundedString(value, label, limit = 512) {
      if (!isString2(value) || value.length === 0 || value.length > limit || value.includes(String.fromCharCode(0))) {
  ...
  "packages/Epoch.Community.Core/dist/fields.js"(exports) {
    ...
    function validateScalar(fieldDefinition, value) {
      ...
      switch (fieldDefinition.type) {
        case "number":
          if (!isNumber2(value) || !Number.isFinite(value))
        ...
        case "datetime":
          ...
          break;
        case "object-id":
          if (!isString2(value) || !OBJECT_ID.test(value))
        ...
        case "keyword":
        case "text":
          if (!isString2(value) || value.length > 1e6)
            throw invalidValue(fieldDefinition, "must be a bounded string");
          result = value.normalize("NFC");
          break;
      }
      if (fieldDefinition.enumValues !== void 0 && isString2(result) && !fieldDefinition.enumValues.includes(result)) {
...
`;
    ...
    function integerArg(value, label, minimum, maximum) {
      if (!isNumber2(value) || !Number.isSafeInteger(value) || value < minimum || value > maximum)
...
var require_ids = __commonJS({
  "packages/Epoch.Protocol/dist/ids.js"(exports) {
    ...
    function platformRandom(byteLength) {
      ...
      if (crypto2 === void 0 || !__epochIsFunction(crypto2.getRandomValues)) {
  ...
  "packages/Epoch.Protocol/dist/posture.js"(exports) {
    ...
    function optionalEnum(row, keys, allowed2) {
      for (const key of keys) {
        ...
        if (value === void 0)
          continue;
        if (__epochIsString(value) && allowed2.includes(value))
          return (
...
var require_dist2 = __commonJS({
  "packages/Epoch.Community.Core/dist/index.js"(exports) {
    ...
    function errorMessage(value) {
      ...
      return isString2(error) ? error : void 0;
    }
...
// packages/Epoch.Community.Web/src/value-kind.ts
...
var requestedMode = new URL(self.location.href).searchParams.get("mode") ?? "memory";
var allowed = /* @__PURE__ */ new Set(["memory", "opfs", "opfs-wl", "opfs-sahpool"]);
var mode = [...allowed].find((candidate) => candidate === requestedMode);
if (mode === void 0) throw new Error("Unsupported Epoch SQLite Worker storage mode");
