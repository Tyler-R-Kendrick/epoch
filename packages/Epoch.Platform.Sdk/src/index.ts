...
export class EpochPlatformSdk {
  ...
  constructor(private readonly core: Core.EpochPlatformCore) {
    ...
    this.identity = {
      ...
      mintFabricCredential: (input: Core.MintFabricCredentialInput) => this.core.mintFabricCredential(input),
      verifyFabricCredential: (secret: string) => this.core.verifyFabricCredential(secret),
      revokeFabricCredential: (id: string) => this.core.revokeFabricCredential(id),
