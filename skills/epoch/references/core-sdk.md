...
Frontier packages add `@epoch/protocol` browser-safe IDs, errors, schemas,
revsets, and inspection; Core change/transaction/conflict, object/chunk/promise,
...
so. See [Frontier VCS Convergence](../../../docs/frontier-vcs-convergence.md).
